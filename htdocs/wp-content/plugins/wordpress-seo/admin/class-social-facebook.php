...
class Yoast_Social_Facebook_Form {
	...
	private function form_head() {
		...
		printf( __( 'More info can be found %1$son our knowledge base%2$s.', 'wordpress-seo' ), '<a target="_blank" href="https://yoa.st/facebook-insights">', '</a>' );
		echo '</p>';
	...
	private function form_thickbox() {
		...
		echo '<p>';
		/* translators: %1$s and %2$s expand to a link to the Yoast Knowledge Base */
		printf( __( 'If you don\'t know where to find the needed ID, see %1$sthis knowledge base article%2$s.', 'wordpress-seo' ), '<a target="_blank" href="https://yoa.st/facebook-insights">', '</a>' );
		echo '</p>';
