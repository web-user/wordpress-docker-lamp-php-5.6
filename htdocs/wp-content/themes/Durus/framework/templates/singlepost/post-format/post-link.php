...
<div id="post-<?php the_ID(); ?>" <?php post_class(' post-standard post-standard-no-border post-single  clearfix '); ?>>
  <div class="post-format-container">
    <div class="post-format-blockquote"> <i class="ss-air ss-link"></i>
      <blockquote>
        <?php the_content(); ?>
      </blockquote>
    </div>
